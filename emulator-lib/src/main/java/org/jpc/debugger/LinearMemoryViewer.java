        ...
        protected Object formatMemoryDisplay(int address)
        {
            ...
            for (int i=0; i<4; i++, address++)
            {
                ...
                else
                {
                    ...
                    buf.append("<font color='#"+colourString+"'>"+ MemoryViewPanel.zeroPadHex(0xFF & val, 2)+"</font>");
                }
            }
            buf.append("</HTML>");
            return buf;
        ...
        protected Object formatAsciiDisplay(int address)
        {
            ...
            for (int i=0; i<16; i++, address++)
            {
                ...
                if (mem == null)
                    ...
                    buffer.append(MemoryViewPanel.getASCII(mem.getByte(address & AddressSpace.BLOCK_MASK)));
            }
